    ...
    menuItems: [
      {
        ...
        label: 'Gerênciar',
        route: '#',
        children: [{ label: 'Importar Funcionarios', route: '/import-employees' },{ label: 'Listar Funcionários', route: '/employees' }]
      },
    ]
  }
])
...
<template>
  ...
  >
    ...
    <div class="flex items-center justify-center gap-2 px-6 py-5.5 lg:py-6.5">
      ...
      <span class="text-white text-center  text-4xl">Movli</span>
    </div>
    <!-- SIDEBAR HEADER -->
